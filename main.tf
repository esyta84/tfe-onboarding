...
module "team_onboarding" {
  ...
  platform_varset_ids = {
    vsphere = contains(each.value.platforms, "vsphere") ? module.platform_varsets.vsphere_varset_id : ""
    aws     = contains(each.value.platforms, "aws") ? module.platform_varsets.aws_varset_id : ""
    azure   = contains(each.value.platforms, "azure") ? module.platform_varsets.azure_varset_id : ""
  }
